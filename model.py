...
def forward_calc(self, sentence, chars, chars2_length, d):
	...
	feats = self._get_model_features(sentence, chars, chars2_length, d)
...
def get_neg_log_likelihood(self, sentence, tags, chars2, chars2_length, d):
	...
	feats = self._get_model_features(sentence, chars2, chars2_length, d)
...
class Model_CRF(nn.Module):
	...
	def __init__(self, vocab_size, tag_to_ix, embedding_dim, hidden_dim,
				 ...
				 , use_crf=True, char_mode='CNN', model_mode='LSTM'):
		'''
		Input parameters:
	...
	_get_model_features = get_model_features
